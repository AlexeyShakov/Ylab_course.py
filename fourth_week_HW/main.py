...
from src.api.v1.resources import posts, users, authorization
from src.core import config
from src.db import cache, redis_cache

# TRUNCATE "user" RESTART IDENTITY; delete all data from database table
app = FastAPI(
...
app.include_router(router=authorization.router, prefix="/api/v1")
